...
@Component({
  selector: 'component-tasks-details-comments',
  imports: [
    CommonModule, FormsModule
  ],
  templateUrl: './comments.component.html',
})
export class ComponentTasksDetailsComments {
  ...
  comentarios: any[] = [
    ...
    },
    {
      ...
      texto: 'Repositorio de github frontend: https://github.com/alessodz/utp_task_frontend',
      foto: 'https://class.utp.edu.pe/static/media/student.42525dea.svg',
      tiempo: 'Hace 2h',
    },
  ];
